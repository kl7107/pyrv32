...
python3 nethack-3.4.3/sys/pyrv32/scripts/run_makedefs_data.py
python3 nethack-3.4.3/sys/pyrv32/scripts/run_makedefs_oracles.py
python3 nethack-3.4.3/sys/pyrv32/scripts/run_makedefs_rumors.py
python3 nethack-3.4.3/sys/pyrv32/scripts/run_makedefs_quest.py
python3 nethack-3.4.3/sys/pyrv32/scripts/run_makedefs_options.py
```

Or from this directory:

```bash
# From nethack-3.4.3/sys/pyrv32/scripts directory
python3 run_makedefs_data.py
python3 run_makedefs_oracles.py
python3 run_makedefs_rumors.py
python3 run_makedefs_quest.py
python3 run_makedefs_options.py
```
...
- **`run_makedefs_data.py`** - Generate `data` file (53.6M instructions, 205KB)
  - Input: `data.base`
  - Flag: `-d`
  
- **`run_makedefs_oracles.py`** - Generate `oracles` file (1.7M instructions, 5.9KB)
  - Input: `oracles.txt`
  - Flag: `-h`
  
- **`run_makedefs_rumors.py`** - Generate `rumors` file (6.1M instructions, 42KB)
