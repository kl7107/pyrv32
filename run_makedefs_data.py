...
2. Copy data.base from nethack-3.4.3/dat/
3. Run makedefs -d
...
INPUT_FILE = "data.base"
OUTPUT_FILE = "data"

print("=" * 60)
print("CLEAN GENERATION: data")
print("=" * 60)
...
print(f"\n[4/7] Running makedefs -d in simulator...")
...
for i, byte in enumerate(b'-d\x00'):
...
exec_result = sim.run(max_steps=100_000_000)  # data takes longer
