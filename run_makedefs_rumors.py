...
2. Copy rumors.tru and rumors.fal from nethack-3.4.3/dat/
3. Run makedefs -r
4. Verify rumors file created
"""
...
print(f"\n[4/7] Running makedefs -r in simulator...")
...
for i, byte in enumerate(b'-r\x00'):
